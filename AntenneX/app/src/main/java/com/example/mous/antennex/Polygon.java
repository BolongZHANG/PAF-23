...
/**
 * Created by Salim on 23/06/2017.
 */
...
public class Polygon
{
    ...
    public static class Builder
    {
         ...
         * @return The builder
         */
        public Builder addVertex(ArrayList<Point>liste)
        { if (_isClosed) {
            ...
            updateBoundingBox((Point)liste.get(i));
            _vertexes.add((Point)liste.get(i));

            // add line (edge) to the polygon
            if (_vertexes.size() > 0) {
                Line Line = new Line(_vertexes.get(_vertexes.size() - 1), (Point)liste.get(i));
                _sides.add(Line);
            }
        }
